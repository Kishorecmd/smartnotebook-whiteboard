...
export const ZoomControls: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-30 flex items-center gap-1.5 p-1.5 bg-slate-900/90 backdrop-blur-2xl border border-slate-700/60 rounded-2xl shadow-2xl select-none ring-1 ring-white/10">
      {/* Zoom Out */}
      <button
        type="button"
        onClick={zoomOut}
